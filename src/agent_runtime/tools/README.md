...
`middleware/restricted_tool_approval.py` gates both mutation tools and checks stale content;
`workflows/file_approval.py` supplies the policy configuration.
There are no application-defined file tools.
