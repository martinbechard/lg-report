...
writes a JSON projection consumed by report/export_excel.mjs; it does not invoke
...
from lg_report.report.pricing import load_prices, summarize
from lg_report.report.render import conversation_turns, tree_rows
